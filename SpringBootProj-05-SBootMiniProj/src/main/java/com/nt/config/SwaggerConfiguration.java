...
public class SwaggerConfiguration {
	...
	public Docket createDocket() {
		...
		private ApiInfo getApiInfo() {
			Contact contact = new Contact("Lokesh", "http://www.HCL.com/tourist", "lokesh@gmail.com");
					return new ApiInfo("Tourist API", "Gives Info Tourist Activities", "3.4 RELEASE", "http://www.hcl.com/license",
